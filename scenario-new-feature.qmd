...
Data providers, service curators, and train leadership need to be able to easily understand the features (tickets) contained in each release of a service. To achieve this:
...
* SIT - should receive all new published artifacts in order to allow service maintainers to test the new version of the service.
* UAT - artifacts will be promoted to UAT on successful SIT testing.
* Production - artifacts to be promoted to production following successful stakeholder testing in UAT or 2 weeks, whichever is sooner. **Exception: failed tests in UAT blocks promotion to production.**
